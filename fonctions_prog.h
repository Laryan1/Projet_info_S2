...
void initialisation(FILE* graphe,SOMMET* liste_sommets, long* nb_sommets, long* nb_arcs, Liste* tab_hach,long taille_tab_hach, int* choix);																								//Lit l'intégralité du fichier et récupère et stocke toutes les informations nécessaires.
