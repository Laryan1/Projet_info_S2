...
} SOMMET ;						// int lecture_ligne(FILE* graphe, char* ligne);								//Lit une ligne du fichier "fp" et l'écrit dans la chaine de caractère "ligne".

void lecture_fichier(FILE* graphe,SOMMET* liste_sommets, long* nb_sommets, long* nb_arcs);																								//Lit l'intégralité du fichier et récupère et stocke toutes les informations nécessaires.
